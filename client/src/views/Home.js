    ...
    return (
        <div className='w-full h-screen bg-[#282c34] pt-3'>
            ...
            <div className='absolute top-1/3 left-1/2 w-4/5 -translate-x-[50%] -translate-y-[50%] text-center'>
                <motion.h1 variants={motionAni(0.2)} initial="hidden" animate='visible' className='text-[75px] leading-none tracking-tighter font-semibold text-blck'>Track, manage, save, thrive</motion.h1>
                <motion.h2 variants={motionAni(0.4)} initial="hidden" animate='visible' className='mt-3 text-center opacity-85 text-[27px] font-semibold leading-none tracking-normal text-black'>Transform your financial habits<br />with BudgetBuddy's intuitive expense tracker.</motion.h2>
